...
const CACHE_VERSION = "lava-v4";
const ASSETS = ["./", "index.html", "catalog.json", "favicon-16x16.png", "favicon-32x32.png", "apple-touch-icon.png", "manifest.webmanifest", "icon-192.png", "icon-512.png"];
